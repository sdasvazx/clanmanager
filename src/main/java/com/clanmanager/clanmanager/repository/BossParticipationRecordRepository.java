...
public interface BossParticipationRecordRepository
    ...
    List<BossParticipationRecord>
    findAllByOrderByBossDateDescCutTimeDescCreatedAtDesc();

    Page<BossParticipationRecord>
    findAllByOrderByBossDateDescCutTimeDescCreatedAtDesc(Pageable pageable);
